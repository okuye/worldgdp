...
import com.klxsolutions.worldgdp.dao.CountryDAO;
import com.klxsolutions.worldgdp.external.WorldBankApiClient;
import com.klxsolutions.worldgdp.model.Country;
...
public class CountryAPIController {
    ...
    public ResponseEntity<?> getCountryDetail(@PathVariable String countryCode) {
        try {
            Country country = countryDao.getCountryDetail(countryCode);
            return ResponseEntity.ok(country);
        } catch(Exception ex) {
            System.out.println("Error while getting country details for: " + countryCode + ex);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error while getting country details");
        }
    }
    ...
    public ResponseEntity<?> editCountry(
        ...
        try {
            ...
            System.out.println("Error while editing the country: " + countryCode + " with data: " + country + ex);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
